    ...
    <main className="min-h-screen bg-light text-primary selection:bg-accent selection:text-white">
      ...
      <section className="pt-40 pb-20 bg-warm-bg text-primary rounded-b-[4rem]">
        <div className="container mx-auto px-6 max-w-4xl space-y-8 text-center">
          <div className="flex items-center justify-center gap-6 text-[11px] font-bold uppercase tracking-widest text-primary/50">
      ...
      <section className="py-24">
        <div className="container mx-auto px-6 max-w-3xl">
          <article className="prose prose-lg md:prose-xl prose-headings:font-heading prose-headings:font-bold prose-h2:text-4xl prose-h2:mt-16 prose-h2:mb-8 prose-h2:text-primary prose-p:text-primary/70 prose-p:leading-relaxed prose-a:text-accent prose-li:text-primary/70 max-w-none">
      ...
      <section className="py-24 bg-warm-bg text-primary rounded-t-[4rem] relative overflow-hidden">
