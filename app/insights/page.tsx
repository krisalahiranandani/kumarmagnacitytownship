...
export default function InsightsIndexPage() {
  ...
  return (
    <main className="min-h-screen bg-light text-primary selection:bg-accent selection:text-white">
      ...
      <section className="pt-40 pb-24 bg-warm-bg text-primary rounded-b-[4rem]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {posts.map((post) => (
              <Link 
                ...
                key={post.slug}
                className="group block bg-white rounded-[2rem] border border-primary/5 overflow-hidden hover:shadow-2xl hover:border-accent/30 transition-all duration-500"
              >
                <div className="h-64 overflow-hidden relative">
                  ...
                  />
                  <div className="absolute top-4 left-4 z-20 bg-white/90 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest text-primary flex items-center gap-2">
                ...
                <div className="p-8 space-y-4">
                  ...
                  <p className="text-sm text-primary/60 leading-relaxed line-clamp-3">
                    {post.excerpt}
                  </p>
