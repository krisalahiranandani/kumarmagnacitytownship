    ...
    >
      <div className="space-y-32">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
           {STATS.map((stat, idx) => (
             <div key={idx} className="p-10 bg-white rounded-[3rem] border border-primary/5 shadow-sm text-center space-y-4">
                <p className="text-accent uppercase font-black tracking-widest text-xs">{stat.label}</p>
                <div className="text-5xl font-heading font-bold text-primary">{stat.value}</div>
                <p className="text-primary/40 text-sm">{stat.detail}</p>
             </div>
           ))}
        </div>

        <div className="bg-warm-bg text-primary rounded-[4rem] p-12 md:p-24 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
           <div className="space-y-8">
              ...
              <div className="flex gap-4">
                 <div className="flex items-center gap-2 bg-white/5 border border-primary/10 px-4 py-2 rounded-full text-[10px] font-bold uppercase tracking-widest text-accent">
           ...
           <div className="bg-white/5 backdrop-blur-xl border border-primary/10 p-12 rounded-[3rem] space-y-6">
        ...
        <div className="max-w-6xl mx-auto space-y-12 py-16">
           <div className="text-center space-y-4">
              <h3 className="text-3xl md:text-5xl font-heading font-bold text-primary">Expert Take <span className="text-primary italic font-light">Insight</span></h3>
              <p className="text-primary/50 text-lg">Straight facts on who should invest in Kumar Magnacity, and why.</p>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-10 rounded-3xl border border-primary/20 bg-primary/5 space-y-6">
                 ...
                 <ul className="space-y-4">
                    <li className="text-primary/70 border-b border-primary/5 pb-2">Ideal for <strong>long-term investment</strong> (5–10 years horizon) for maximum multiplier effect.</li>
                    <li className="text-primary/70 border-b border-primary/5 pb-2">Strongest option for end-users seeking the independent <strong>villa lifestyle</strong> near IT hubs.</li>
                    <li className="text-primary/70 border-b border-primary/5 pb-2">Perfect for HNI buyers transitioning out of high-density apartments.</li>
                 </ul>
              </div>

              <div className="p-10 rounded-3xl border border-primary/10 bg-white shadow-xl space-y-6">
                 <h4 className="text-xl font-bold text-primary flex items-center gap-3">
                    <span className="text-red-500 text-2xl">❗</span> Practical Considerations
                 </h4>
                 <ul className="space-y-4">
                    <li className="text-primary/70 border-b border-primary/5 pb-2">Not ideal for short-term flipping unless bought during early-phase access.</li>
                    <li className="text-primary/70 border-b border-primary/5 pb-2">Buyers should actively compare plotted projects (e.g., Godrej, VTP plots) to understand the massive 150-acre scale advantage.</li>
                    <li className="text-primary/70 border-b border-primary/5 pb-2">Evaluate central vs peripheral plot locations for future resale premium.</li>
                 </ul>
              </div>
           </div>
        </div>
