    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {AMENITIES_LIST.map((item, idx) => (
          <div key={idx} className="group p-10 bg-white rounded-[3rem] border border-primary/5 shadow-sm hover:shadow-2xl hover:border-accent/30 transition-all duration-500">
      ...
      <div className="mt-40 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
         ...
         <div className="space-y-8">
            <h3 className="text-4xl font-heading font-bold text-primary italic leading-tight">"Where your backyard is a 150-acre curated estate."</h3>
            <p className="text-primary/60 font-light text-xl leading-relaxed">
