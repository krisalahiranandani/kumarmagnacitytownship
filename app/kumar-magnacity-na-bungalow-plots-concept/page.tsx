...
export default function ConceptPage() {
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div className="space-y-8">
           <div className="space-y-4">
             <h2 className="text-3xl font-heading font-bold text-primary">Landed Estate Mastery</h2>
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
             <div className="p-6 bg-white rounded-2xl border border-primary/5 shadow-sm">
                ...
                <p className="text-xs text-primary/40">3-tier gated entry and 24/7 surveillance.</p>
             </div>
             <div className="p-6 bg-white rounded-2xl border border-primary/5 shadow-sm">
                <LandPlot className="text-accent mb-4" size={24} />
                <h4 className="font-bold mb-2">25+ Acres of Green</h4>
                <p className="text-xs text-primary/40">Immersive landscaped greens designed for holistic wellness.</p>
             </div>
             <div className="p-6 bg-white rounded-2xl border border-primary/5 shadow-sm sm:col-span-2 flex items-center justify-between">
                <div>
                  <h4 className="font-bold mb-2">A City Within a City</h4>
                  <p className="text-xs text-primary/40">Featuring high street retail, food courts, schools, and healthcare inside the township.</p>
                </div>
        ...
        <div className="relative">
           <div className="aspect-[4/5] bg-primary/5 rounded-[3rem] overflow-hidden">
              <div className="absolute inset-0 bg-[url('/assets/amenities.jpg')] bg-cover bg-center" />
           </div>
           <div className="absolute -bottom-10 -left-10 bg-accent p-10 rounded-[2rem] text-primary shadow-2xl hidden md:block">
      ...
      <div className="mt-40 bg-warm-bg text-primary rounded-[4rem] p-12 md:p-24 overflow-hidden relative">
         ...
         <div className="relative z-10 max-w-2xl">
            ...
            <div className="flex items-center gap-4 border-t border-primary/10 pt-8 mt-8">
