...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Kumar Magnacity 2 BHK 757 sq ft price",
    "Kumar Magnacity 3 BHK 1053 sq ft",
    "Kumar Magnacity Sovereign NA Villa Plots",
    "Kumar Magnacity floor plans PDF",
    "Kumar Magnacity sample flat video 360",
    "Kumar Magnacity possession date",
    "Kumar Magnacity site visit booking",
    "Kumar Magnacity sales desk +91 77440 09295",
    "Kumar Magnacity vs Godrej Rivergreens",
    "Kumar Magnacity vs Amanora Park Town",
    "Flats near Podar International School Manjari",
    "Townships near Magarpatta Cybercity Pune",
