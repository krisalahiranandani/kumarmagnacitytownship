...
export default function sitemap({ id }: { id: number }): MetadataRoute.Sitemap {
  ...
  if (id === 0) {
    const corePages = [
      ...
      { route: "/kumar-magnacity-price", priority: 1.0, freq: 'daily' as const },
      { route: "/kumar-magnacity-rera", priority: 0.95, freq: 'daily' as const },
      ...
      { route: "/kumar-magnacity-location-advantages-hadapsar-manjari", priority: 0.95, freq: 'daily' as const },
      ...
      { route: "/nri-investment", priority: 0.9, freq: 'daily' as const },
      { route: "/compare/kumar-magnacity-vs-godrej-rivergreens-manjari", priority: 0.9, freq: 'weekly' as const },
      { route: "/compare/kumar-magnacity-vs-amanora-park-town-hadapsar", priority: 0.9, freq: 'weekly' as const },
      { route: "/compare/kumar-magnacity-vs-shapoorji-joyville-hadapsar", priority: 0.9, freq: 'weekly' as const },
      { route: "/compare/kumar-magnacity-vs-vtp-pegasus-kharadi", priority: 0.9, freq: 'weekly' as const },
