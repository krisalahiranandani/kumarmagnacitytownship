          ...
          {faqJson.mainEntity.map((item, index) => (
            <div 
              ...
              className={cn(
                ...
                openIndex === index ? "border-accent shadow-xl" : "border-primary/5 shadow-sm hover:border-primary/20"
              )}
            >
              <button
              ...
              >
                <span className="font-heading font-bold text-lg md:text-xl text-primary group-hover:text-primary transition-colors pr-4">
                  {item.name}
                </span>
                <div className={cn(
                  "shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-all",
                  openIndex === index ? "bg-accent text-white rotate-180" : "bg-primary/5 text-primary/40"
                )}>
              ...
              <div className={cn(
                ...
                <div className="p-6 md:p-8 pt-0 border-t border-primary/5">
                  <p className="text-primary/60 leading-relaxed text-base">
