...
export default function GoogleProductSchema() {
  const productCatalogData = [
    {
      ...
      "sku": "KM-2BHK-757",
      "mpn": "P52100052096",
      "category": "Real Estate > Residential Properties > 2 BHK Apartments",
      "aggregateRating": {
    ...
    },
    {
      ...
      "sku": "KM-3BHK-1053",
      "mpn": "P52100052096",
      "category": "Real Estate > Residential Properties > 3 BHK Apartments",
      "aggregateRating": {
        "@type": "AggregateRating",
        "ratingValue": "4.9",
        "reviewCount": "386",
    ...
    },
    {
      ...
      "sku": "KM-PLOT-1700",
      "mpn": "P52100054476",
      "category": "Real Estate > Land & Plots > NA Residential Plots",
      "aggregateRating": {
        "@type": "AggregateRating",
        "ratingValue": "4.9",
        "reviewCount": "386",
  ...
  return (
    <>
      {productCatalogData.map((item, idx) => (
        <script
          key={idx}
