...
export default function InvestmentCalculator() {
  ...
  return (
    <div className="w-full bg-warm-bg rounded-[3rem] border border-primary/5 shadow-2xl overflow-hidden relative">
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-accent/5 blur-[120px] rounded-full pointer-events-none" />
      
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 divide-y lg:divide-y-0 lg:divide-x divide-primary/10 relative z-10">
        ...
        <div className="p-8 md:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h3 className="text-3xl font-heading font-bold text-primary">Investment Calculator</h3>
            <p className="text-sm text-primary/50">Estimate your monthly commitments and ROI.</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-end">
                <label className="text-xs font-medium text-primary/60 uppercase tracking-wider">Property Value</label>
                <span className="text-xl font-bold text-primary">{formatCurrency(propertyValue)}</span>
              </div>
              <input 
                type="range" min="5000000" max="30000000" step="500000"
                value={propertyValue} onChange={(e) => setPropertyValue(Number(e.target.value))}
                className="w-full accent-accent h-1 bg-primary/10 rounded-lg appearance-none cursor-pointer"
              />
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-end">
                <label className="text-xs font-medium text-primary/60 uppercase tracking-wider">Down Payment ({downPaymentPerc}%)</label>
                <span className="text-xl font-bold text-primary">{formatCurrency(calculations.downPayment)}</span>
              </div>
              <input 
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-3">
                <div className="flex justify-between items-end">
                  <label className="text-xs font-medium text-primary/60 uppercase tracking-wider">Interest Rate</label>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-end">
                  <label className="text-xs font-medium text-primary/60 uppercase tracking-wider">Tenure</label>
                  <span className="text-xl font-bold text-primary">{tenureYears} Yrs</span>
                </div>
                <input 
        ...
        <div className="p-8 md:p-12 bg-primary/[0.02] flex flex-col justify-center space-y-10">
          ...
          <div className="space-y-2">
            <h4 className="text-sm text-primary/50 uppercase tracking-widest font-medium">Estimated EMI</h4>
            <div className="flex items-end gap-2">
              ...
              <span className="text-primary/40 mb-2">/ month</span>
            </div>
          </div>

          {/* Visual Progress Bar */}
          <div className="space-y-4">
            <div className="flex justify-between text-xs font-medium text-primary/60 uppercase tracking-wider">
            ...
            <div className="h-4 w-full bg-primary/5 rounded-full overflow-hidden flex shadow-inner">
              <motion.div 
                initial={{ width: 0 }}
          ...
          {/* ROI Metric */}
          <div className="bg-light border border-primary/5 p-6 rounded-2xl flex items-center justify-between gap-4">
            <div className="space-y-1">
              <div className="text-xs text-primary/50 uppercase tracking-widest font-medium flex items-center gap-2">
                <TrendingUp size={12} className="text-green-400" /> Projected ROI
              </div>
              <div className="text-lg font-bold text-primary">12-15% Est. YoY Growth</div>
            </div>
            <PieChart className="text-primary/10" size={40} />
          </div>
          ...
          <button
            ...
            className="w-full bg-accent text-white hover:bg-primary hover:text-white transition-all py-5 rounded-xl font-bold uppercase tracking-[0.2em] flex items-center justify-center gap-3"
          >
