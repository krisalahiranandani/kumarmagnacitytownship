...
export default function PersonaDeepDive({
  ...
  return (
    <section ref={containerRef} className="py-24 md:py-40 bg-warm-bg relative">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-24 items-start">
          ...
          <aside className="lg:col-span-5 lg:sticky lg:top-40 space-y-6" aria-labelledby="persona-title">
            ...
            >
              ...
              <h2 id="persona-title" className="text-4xl md:text-6xl font-heading font-bold text-primary leading-tight">
                {personaTitle}
              </h2>
            ...
            {features.map((feature, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative glass-obsidian p-10 md:p-12 rounded-[2.5rem] border border-primary/10 hover:border-primary/20 transition-colors bg-light backdrop-blur-xl">
                    <div className="flex flex-col md:flex-row gap-6 items-start">
                      <div className={cn(
                        "w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 border",
                        isGold ? "bg-accent/10 border-accent/20 text-accent" : "bg-primary/10 border-primary/20 text-primary"
                      )} aria-hidden="true">
