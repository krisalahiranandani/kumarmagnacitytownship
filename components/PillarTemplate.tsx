...
export default function PillarTemplate({
  ...
  return (
    <main className="min-h-screen bg-light">
      ...
      <section className="relative pt-48 pb-24 md:pt-64 md:pb-32 overflow-hidden bg-warm-bg">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-warm-bg/80 via-primary/30 to-warm-bg" />
        ...
        <div className="container mx-auto max-w-7xl px-6 md:px-12 relative z-10">
          <div className="max-w-4xl space-y-10 reveal-luxury">
            ...
            <div className="space-y-6">
              <h1 className="text-4xl md:text-6xl lg:text-8xl font-heading font-bold text-primary leading-[1.05] tracking-tight">
                {title.split(' ').map((word, i) => (
                  <span key={i} className={cn(i === 2 || i === 4 ? "text-accent italic font-light" : "text-primary")}>
                    {word}{' '}
                  </span>
                ))}
              </h1>
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-primary/60 font-light leading-relaxed max-w-2xl border-l border-primary/40 pl-8">
              {subtitle}
            </p>
          </div>
        </div>
        ...
        <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-warm-bg to-transparent opacity-50" />
      </section>
