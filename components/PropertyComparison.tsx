...
export default function PropertyComparison() {
  ...
  return (
    <section className="py-24 bg-dark text-white relative overflow-hidden" id="compare">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {PROPERTY_OPTIONS.map((prop, idx) => (
            <motion.div
              ...
              className="bg-white/5 border border-white/10 rounded-[3rem] p-8 space-y-8 flex flex-col justify-between hover:border-accent/50 transition-all duration-500 hover:scale-[1.02] shadow-2xl relative overflow-hidden group"
            >
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-white/40 uppercase tracking-widest">Kumar Magnacity</span>
                </div>

                <div className="space-y-2">
                  <h3 className="text-2xl font-heading font-bold text-white tracking-tight">{prop.type}</h3>
                  <div className="text-4xl font-heading font-bold text-accent pt-2">{prop.price}</div>
                  <p className="text-xs text-white/40">Est. EMI: {prop.emi}</p>
                </div>

                <div className="space-y-3 pt-4 border-t border-white/10 text-xs">
                  <div className="flex justify-between py-1 border-b border-white/5">
                    <span className="text-white/40">Carpet / Plot Area:</span>
                    <span className="font-bold text-white">{prop.carpetArea}</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-white/5">
                    <span className="text-white/40">Target Possession:</span>
                    <span className="font-bold text-white">{prop.possession}</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-white/5">
                    <span className="text-white/40">Ideal Profile:</span>
                    <span className="font-semibold text-accent">{prop.idealFor}</span>
                  </div>
                </div>

                <div className="space-y-3 pt-4">
                  <span className="text-[10px] text-white/40 uppercase font-bold tracking-widest">Key Highlights</span>
              ...
              <div className="pt-6">
                <button
                  ...
                  className="w-full bg-accent text-dark font-black uppercase tracking-[0.2em] py-4 rounded-2xl transition-all flex items-center justify-center gap-3 hover:bg-accent-hover text-xs shadow-xl"
                >
                  GET FULL BREAKDOWN
                  <ArrowRight size={14} />
                </button>
