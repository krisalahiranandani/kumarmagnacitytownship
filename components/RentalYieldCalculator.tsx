...
export default function RentalYieldCalculator() {
  ...
  return (
    <section className="py-24 bg-[#050505] border-t border-white/10 relative overflow-hidden" id="rental-yield-calculator">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl space-y-8">
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <h3 className="text-base font-serif font-bold text-white mb-1">2 BHK Luxury Suite</h3>
                  <p className="text-xs text-gray-400 font-mono">757 Sq.Ft • ₹72.99 Lakhs*</p>
                </button>
                <button
                ...
                >
                  <h3 className="text-base font-serif font-bold text-white mb-1">3 BHK Premium Suite</h3>
                  <p className="text-xs text-gray-400 font-mono">1053 Sq.Ft • ₹1.05 Cr.*</p>
                </button>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center text-sm">
                <span className="text-gray-400 font-mono">Investment Horizon</span>
          ...
          <div className="lg:col-span-5 bg-gradient-to-b from-white/10 to-white/5 border border-accent/30 rounded-3xl p-8 backdrop-blur-2xl shadow-2xl space-y-6">
            <div className="flex justify-between items-center border-b border-white/10 pb-4">
              <span className="text-xs font-mono text-gray-400 uppercase font-bold">Est. Monthly Rental</span>
              <span className="text-2xl font-bold text-emerald-400 font-mono">₹{monthlyRent.toLocaleString("en-IN")}/mo</span>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center text-sm">
                <span className="text-gray-400">Projected Value in {holdingYears} Yrs</span>
                <span className="font-bold text-white font-mono">₹{(projectedValue / 100000).toFixed(2)} Lakhs</span>
              </div>
              <div className="flex justify-between items-center text-sm">
                <span className="text-gray-400">Est. Capital Appreciation</span>
                <span className="font-bold text-emerald-400 font-mono">+₹{(totalProfit / 100000).toFixed(2)} Lakhs</span>
              </div>
            </div>
