...
export default function SiteVisitScheduler() {
  ...
  return (
    <section className="py-24 bg-dark text-white relative overflow-hidden" id="site-visit">
      <div className="container mx-auto max-w-7xl px-6 relative z-10">
        <div className="bg-gradient-to-r from-accent/20 via-white/5 to-transparent border border-accent/30 rounded-[3.5rem] p-10 md:p-16 relative overflow-hidden shadow-2xl backdrop-blur-3xl">
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="space-y-3 pt-2">
                <span className="text-xs text-white/40 uppercase font-bold tracking-widest">Select Pickup Region:</span>
            ...
            <div className="lg:col-span-5 bg-white/5 border border-white/10 rounded-[3rem] p-8 md:p-10 text-center space-y-6 shadow-2xl backdrop-blur-2xl">
              ...
              <div className="space-y-2">
                <h3 className="text-2xl font-heading font-bold text-white">Book VIP Walkthrough</h3>
