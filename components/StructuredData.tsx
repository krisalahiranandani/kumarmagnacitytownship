...
export default function StructuredData({
  ...
  const listingSchema: RealEstateListingSchema = {
    ...
    sku: "KM-HADAPSAR-TOWNSHIP-2026",
    mpn: "P52100052096",
    category: "Real Estate > Residential Properties > Master Integrated Township",
    offers: [
      {
        "@type": "Offer",
    ...
    hasMap: "https://maps.google.com/?cid=17409054707127972577",
    sameAs: [
